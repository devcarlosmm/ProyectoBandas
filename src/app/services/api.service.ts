...
export class ApiService {
  ...
  detalleBanda(idBanda: number): Observable<Banda> {
    return this.httpClient
      .get<Banda>(this.baseUrl + 'detalles/' + idBanda)
      .pipe(
  ...
  createBanda(banda: Banda): Observable<Banda> {
    banda.idbanda = null;
    return this.httpClient
      .post<Banda>(this.baseUrl + 'crearbanda', banda, httpOptions)
      .pipe(
        tap((banda: Banda) =>
          this.log(`Banda creada con id: ${banda.idbanda}`)
        ),
  ...
  updateBanda(banda: Banda): Observable<Banda> {
    return this.httpClient
      .post<Banda>(this.baseUrl + 'editar/' + banda.idbanda, banda, httpOptions)
      .pipe(
        tap((banda: Banda) =>
          this.log(`Banda con id: ${banda.idbanda} editada`)
        ),
  ...
  deleteBanda(idBanda: number): Observable<Banda> {
    return this.httpClient
      .delete<Banda>(this.baseUrl + 'borrar/' + idBanda)
      .pipe(
